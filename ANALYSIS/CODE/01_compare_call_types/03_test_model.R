# >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
# Project: voice paper
# Date started: 26-04-2022
# Date last modified: 26-04-2022
# Author: Simeon Q. Smeele
# Description: Testing if we can run a model on 0-1 distributed data and get a better measure of within vs
# between similarity.
# >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
path_model = 'ANALYSIS/CODE/models/m_ind_0_1.stan'
