...
// This version works for 0-1 distributed data (still asuming normal distribution with no limits).
data{
    int N_obs; 
    int N_call;
    int N_rec_pair;
...
model{
    sigma ~ exponential(5);
    sigma_same_ind ~ exponential(5);
    sigma_ind_pair ~ exponential(5);
    sigma_same_rec ~ exponential(5);
    sigma_rec_pair ~ exponential(5);
